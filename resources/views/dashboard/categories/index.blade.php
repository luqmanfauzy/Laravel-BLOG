...
{{-- @dd($categories[0]->id) --}}
    ...
    <div class="p-4 sm:ml-64">
        <h2 class="text-4xl font-semibold m-10">Post Categories</h2>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4 text-left">
                                    <a href="{{ route('dashboard.show', $category->id) }}"
                                    ...
                                    <a href="#" onclick="event.preventDefault(); confirmDelete('{{ $category->id }}');" class="mr-3 text-xl font-medium text-red-700 dark:text-blue-500 hover:underline">
                                        <i class="fa-solid fa-trash"></i>
                                    </a>
                                    
                                    <form id="delete-post-form-{{ $category->id }}" action="{{ route('dashboard.destroy', $category->id) }}" method="POST" style="display: none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </td>
